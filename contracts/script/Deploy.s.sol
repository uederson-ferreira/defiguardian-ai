...
import "../test/RiskGuardian.t.sol"; // ← Import MockAggregator

/**
 * @title DeployComplete
 * @dev Complete deployment script for all RiskGuardian contracts
 */
contract DeployComplete is Script {
    ...
    function _generateDeploymentReport() internal view {
        ...
        console.log("4. Add more risk data providers");

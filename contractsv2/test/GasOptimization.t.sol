...
contract GasOptimizationTest is Test {
    ...
    /**
     * @dev Test AlertSystem gas consumption - FIXED
     */
    function testAlertSystemGas() public {
        vm.startPrank(user1);
        
        // 🔧 FIX: Adicionar bytecode ao protocol1 antes de usar no AlertSystem
        vm.etch(protocol1, hex"6080604052348015600f57600080fd5b50");
